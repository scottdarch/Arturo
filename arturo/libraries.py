...
class LibrarySearchAggregator(Arduino15PackageSearchPathAgent):
    ...
    def __init__(self, console):
        super(LibrarySearchAggregator, self).__init__(
            SearchPath.ARTURO2_HEADER_FILEEXT, console, followLinks=True)
...
class Library(object):
    ...
    # Pattern to match a string which is either a major.minor version or a
    ...
    def __init__(self, libraryName, environment, console, libraryVersion=None, libraryPath=None, libraryPlatform=None):
        ...
        self._libraryVersion = nameAndVersion[
            1] if libraryVersion is None else libraryVersion
        self._name_and_version = self.libNameFromNameAndVersion(
            self._name, self._libraryVersion)
